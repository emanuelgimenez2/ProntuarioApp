    ...
    <Container maxWidth="lg">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Card sx={{ mb: 2 }}>
          ...
          <CardContent>
            <Grid container spacing={2}>
              {['frente', 'cejas', 'parpados', 'boca', 'labios', 'menton', 'orejas'].map((item) => (
                <React.Fragment key={item}>
                  <Grid item xs={12} sm={6}>
                    <TextField
                      fullWidth
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  fullWidth
                  name="narizParticularidades"
                  label="Nariz - Particularidades"
                  value={formData.narizParticularidades}
                  onChange={handleInputChange}
                />
              </Grid>
              <Grid item xs={12} sm={4}>
